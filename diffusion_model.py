...
# It has a step function as an intitial profile.
...
# The discretized version of the diffusion model we'll solve with our model:
# 
...
# Set the intial conditions for the model. 
...
# Loop over the time steps on the model, solving the diffusion equation using the FTCS scheme described above.
